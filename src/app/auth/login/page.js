...
export default function LoginPage()
{
    ...
    const [message, setMessage] = useState({type: '', content: 'Welcome Back!'})
    ...
    async function handleSubmission(e)
    {
        ...
        const [data, error] = await LoginService(email, password, true);
    ...
    return (
        <>
            <h2 className="font-outfit font-semibold text-3xl text-center dark:text-neutral-300 text-gray-700 mb-2">Login</h2>
            ...
            <form className="flex flex-col w-full gap-3" onSubmit={handleSubmission}>
                ...
                <button type="submit" className="mt-4 bg-blue-600 text-white py-2 rounded hover:bg-blue-700 transition">Login</button>
                <a href="/auth/register" className="text-center w-full underline dark:text-white/50">Create New Account</a>
            </form>
        </>
    )
}
